...
const StockInfo = () => {
  ...
  const buyHandler = async (e) => {
    ...
    try {
      ...
      console.log("2");
      const response = await axios.post(`https://v-kbroker-aonr.vercel.app/stock/buystock/${UserId}`,buyinfo, {
        headers: {
      ...
      console.log("4");
      try {
        const url = `https://v-kbroker-aonr.vercel.app/stock/totalprofit/${UserId}`;
  ...
  const sellHandler = async () => {
    ...
    try {
      ...
      const response = await axios.post(`https://v-kbroker-aonr.vercel.app/stock/sellstock/${UserId}`,sellinfo, {
        headers: {
          Authorization: `Bearer ${authToken}`,
        },
        withCredentials: true,
