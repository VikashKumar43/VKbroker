  ...
  const handleCheckboxChange = async () => {
    if(boxchecked){
        try {
            ...
            const response = await axios.post(`https://v-kbroker-aonr.vercel.app/watchlist/removefromwatchlist/${UserId}`,removeticker, {
                headers: {
        ...
        try {
            ...
            const response = await axios.post(`https://v-kbroker-aonr.vercel.app/watchlist/addtowatchlist/${UserId}`,addticker, {
                headers: {
                  Authorization: `Bearer ${authToken}`,
                },
                withCredentials: true,
